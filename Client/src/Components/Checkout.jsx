...
const Checkout = () => {
  const { cart, userAddress, url, user, clearCart } = useContext(AppContext); // Add addToCart here
...
var options = {
  key: "rzp_test_Z0dYRLbMCtvPVZ", // Enter the Key ID generated from the Dashboard
  ...
  prefill: {
    name: "sushant mishra",
    email: "sushant.mishra228@gmail.com",
    contact: "8733033548",
  },
  notes: {
    address: "sadar kakori lucknow up",
  },
  theme: {
    color: "#3399cc",
  },
            ...
            <tr>
              ...
              <td className="bg-dark text-light">
                <ul style={{ fontWeight: "bold" }}>
                  ...
                  <li>Cuntry: {userAddress?.country}</li>
